  ...
  return (
    <div className="relative max-w-[350px]">
      ...
      >
        ...
        {/* Hover Box (Initially Hidden) */}
        {isHovered && (
          <div className="absolute left-[-100px] top-52 z-20 hidden h-[26%] w-[88%] items-center justify-center overflow-hidden rounded-3xl border border-black bg-transparent  p-5 backdrop-blur-md lg:flex ">
