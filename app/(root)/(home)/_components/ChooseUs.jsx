...
const ChooseUs = () => {
  return (
    <div className="bg-[#10001C] text-white xl:px-20 px-8 w-full">
      <div className="flex flex-col justify-center items-center py-14 px-2 lg:py-12 w-full">
        ...
        <Image
          ...
          height={200}
          width={200}
          className="sm:w-[52%] w-[85%] xl:py-8"
        />
        <div className="flex  flex-col space-y-6 mt-8 sm:flex-row sm:space-y-0 sm:space-x-6 lg:space-x-12 ">
          {chooseData &&
            chooseData.map((data) => (
              <div
                key={data._id}
                className="flex flex-col justify-center items-center   text-center py-14 space-y-6 rounded-2xl px-6 backdrop-blur-17 w-full xl:mb-12"
                style={{
                  background:
